...
var blinkTween1 = new TWEEN.Tween(eyeHeight).to({
    s: 0
}, 90).easing(TWEEN.Easing.Exponential.EaseIn);
var blinkTween2 = new TWEEN.Tween(eyeHeight).to({
    s: 1
}, 140).easing(TWEEN.Easing.Exponential.EaseIn);
var blinkTween3 = new TWEEN.Tween(eyeHeight).to({
    s: 0
}, 60).easing(TWEEN.Easing.Exponential.EaseIn);
var blinkTween4 = new TWEEN.Tween(eyeHeight).to({
    s: 1
}, 180).easing(TWEEN.Easing.Exponential.EaseIn);
