...
(function(ea) {
    function Q(Q, da) {
        ...
        var Ca, c = this,
            ...
            s = !1,
            ja = !1,
            L, r, ka, T, la, B, C, D, Ea, ma, U, V, E, na, oa, pa, W, F, Fa, qa, Ga, X, Ha, M = null,
            ra = null,
            u, sa, G, Y, Z, H, p, N = !1,
            ta = !1,
            Ia, Ja, Ka, $ = 0,
            O = null,
            aa, n = null,
            La, ba, P, x, ua, va, Ma, o, Wa = Array.prototype.slice,
            z = !1,
            t, wa, Na, v, Oa, xa = q.match(/(ipad|iphone|ipod)/i),
            y = q.match(/msie/i),
            Xa = q.match(/webkit/i),
        ...
        this.useAltURL = !Ba;
        this._global_a = null;
        if (za && (c.useHTML5Audio = !0, c.preferFlash = !1, xa)) z = c.ignoreFlash = !0;
        this.setup = function(a) {
            "undefined" !== typeof a && k && n && c.ok() && ("undefined" !== typeof a.flashVersion || "undefined" !== typeof a.url) &&
                H(u("setupLate"));
            ka(a);
            return c
        };
        ...
        this.createSound = function(a, e) {
            ...
            if (ba(f)) g = d(), g._setup_html5(f);
            else {
                if (8 < j && null === f.isMovieStar) f.isMovieStar = !(!f.serverURL && !(f.type && f.type.match(Ua) || f.url.match(Ya)));
                f = Z(f, void 0);
                g = d();
                if (8 === j) i._createSound(f.id, f.loops || 1, f.usePolicyFile);
                else if (i._createSound(f.id, f.url, f.usePeakData, f.useWaveformData, f.useEQData, f.isMovieStar, f.isMovieStar ? f.bufferTime : !1, f.loops || 1, f.serverURL, f.duration || null, f.autoPlay, !0, f.autoLoad, f.usePolicyFile), !f.serverURL) g.connected = !0, f.onconnect && f.onconnect.apply(g);
        ...
        this.start = this.play = function(a, e) {
            var d = !1;
            if (!k || !c.ok()) return H("soundManager.play(): " + u(!k ? "notReady" : "notOK")), d;
            if (!p(a)) {
        ...
        this.disable = function(a) {
            ...
            if (s) return !1;
            s = !0;
            for (e = c.soundIDs.length - 1; 0 <= e; e--) Ga(c.sounds[c.soundIDs[e]]);
            L(a);
            o.remove(h, "load", C);
            return !0
        };
        ...
        this.onready = function(a, c) {
            var d = !1;
            if ("function" === typeof a) c || (c = h), la("onready", a, c), B();
            else throw u("needFunction", "onready");
            return !0
        };
        this.ontimeout = function(a, c) {
            var d = !1;
            if ("function" === typeof a) c || (c = h), la("ontimeout", a, c), B({
                type: "ontimeout"
            });
            else throw u("needFunction",
                "ontimeout");
            return !0
        };
        ...
        this.reboot = function() {
            ...
            for (a in w)
                if (w.hasOwnProperty(a))
                    for (e = w[a].length - 1; 0 <= e; e--) w[a][e].fired = !1;
            h.setTimeout(c.beginDelayedInit, 20)
        };
        this.getMoviePercent = function() {
            return i &&
                "undefined" !== typeof i.PercentLoaded ? i.PercentLoaded() : null
        };
        ...
        Ca = function(a) {
            ...
            this.load = function(a) {
                var c = null;
                if ("undefined" !== typeof a) b._iO = r(a, b.options), b.instanceOptions = b._iO;
                else if (a = b.options, b._iO = a, b.instanceOptions = b._iO, n && n !== b.url) b._iO.url = b.url, b.url = null;
                ...
                if (ba(a)) {
                    if (c = b._setup_html5(a), !c._called_load) {
                        b._html5_canplay = !1;
                        if (b._a.src !== a.url) b._a.src = a.url, b.setPosition(0);
                    ...
                    b.isHTML5 = !1, b._iO = Z(Y(a)), a = b._iO, 8 === j ? i._load(b.id, a.url, a.stream, a.autoPlay, a.whileloading ? 1 : 0, a.loops || 1, a.usePolicyFile) : i._load(b.id, a.url, !!a.stream, !!a.autoPlay, a.loops || 1, !!a.autoLoad, a.usePolicyFile)
                } catch (e) {
                    F({
            ...
            this.unload = function() {
                if (0 !== b.readyState) {
                    if (b.isHTML5) {
                        if (I(), b._a) b._a.pause(),
                            ua(b._a, "about:blank"), b.url = "about:blank"
                    } else 8 === j ? i._unload(b.id, "about:blank") : i._unload(b.id);
                    g()
                }
                return b
            };
            this.destruct = function(a) {
                if (b.isHTML5) {
                    if (I(), b._a) b._a.pause(), ua(b._a), z || A(), b._a._t = null, b._a = null
                } else b._iO.onfailure = null, i._destroySound(b.id);
            ...
            this.start = this.play = function(a, c) {
                ...
                if (!b.loaded)
                    if (0 === b.readyState) {
                        ...
                        b.load(b._iO)
                    } else 2 === b.readyState && (d = b);
                if (null !== d) return d;
                if (!b.isHTML5 && 9 === j && 0 < b.position && b.position === b.duration) a.position = 0;
                if (b.paused && b.position && 0 < b.position) b.resume();
                else {
                    b._iO = r(a, b._iO);
                    if (null !== b._iO.from && null !== b._iO.to && 0 === b.instanceCount && 0 === b.playState && !b._iO.serverURL) {
                        ...
                        if (b.isHTML5 && !b._html5_canplay) b.load({
                            _oncanplay: e
                        }), d = !1;
                        else if (!b.isHTML5 && !b.loaded && (!b.readyState || 2 !== b.readyState)) b.load({
                            onload: e
                        }), d = !1;
                        if (null !== d) return d;
                        b._iO = s()
            ...
            this.stop = function(a) {
                ...
                if (1 === b.playState) {
                    ...
                    } else i._stop(b.id, a), c.serverURL && b.unload();
                    b.instanceCount = 0;
                    b._iO = {};
            ...
            this.setPosition = function(a) {
                ...
                var c = b.isHTML5 ? Math.max(a, 0) : Math.min(b.duration || b._iO.duration,
                    Math.max(a, 0));
                b.position = c;
                a = b.position / 1E3;
                ...
                } else a = 9 === j ? b.position : a, b.readyState && 2 !== b.readyState && i._setPosition(b.id, a, b.paused || !b.playState, b._iO.multiShot);
            ...
            this.pause = function(a) {
                ...
                b.paused = !0;
                b.isHTML5 ? (b._setup_html5().pause(),
                    I()) : (a || "undefined" === typeof a) && i._pause(b.id, b._iO.multiShot);
            ...
            this.togglePause = function() {
                if (0 === b.playState) return b.play({
                    position: 9 === j && !b.isHTML5 ? b.position : b.position /
                        1E3
                }), b;
            ...
            this.setVolume = function(a, e) {
                ...
                } else i._setVolume(b.id, c.muted && !b.muted || b.muted ? 0 : a);
                b._iO.volume = a;
            ...
            this.unmute = function() {
                ...
                } else i._setVolume(b.id, a ? b._iO.volume : b.options.volume);
                return b
            };
            ...
            this.clearOnPosition = function(b, a) {
                ...
                for (c = 0; c < k.length; c++)
                    if (b === k[c].position && (!a || a === k[c].method)) k[c].fired && o--, k.splice(c, 1)
            };
            this._processOnPosition = function() {
                ...
                for (a -= 1; 0 <= a; a--)
                    if (c = k[a], !c.fired && b.position >= c.position) c.fired = !0, o++, c.method.apply(c.scope, [c.position]);
                return !0
            };
            this._resetOnPosition = function(b) {
                ...
                if (!a) return !1;
                for (a -= 1; 0 <= a; a--)
                    if (c = k[a], c.fired && b <= c.position) c.fired = !1, o--;
                return !0
            };
            s = function() {
                var a = b._iO,
            ...
            this._setup_html5 = function(a) {
                ...
                if (d) {
                    if (d._t) {
                        if (!z && i === e(n)) A = d;
                        else if (z && h.url === a.url && (!n || n === h.url)) A = d;
                        if (A) return b._apply_loop(d, a.loops), A
                    }
                    ...
                    n = b.url = a.url;
                    d._called_load = !1
                } else if (b._a = a.autoLoad || a.autoPlay ? new Audio(a.url) : Pa ? new Audio(null) : new Audio, d = b._a, d._called_load = !1, z) c._global_a = d;
                b.isHTML5 = !0;
                b._a = d;
                d._t = b;
                f();
            ...
            f = function() {
                ...
                for (a in v) v.hasOwnProperty(a) && b._a && b._a.addEventListener(a, v[a], !1);
                return !0
            };
            A = function() {
                var a;
                b._a._added_events = !1;
                for (a in v) v.hasOwnProperty(a) && b._a && b._a.removeEventListener(a, v[a], !1)
            };
            ...
            this._onfinish = function() {
                ...
                if (b.instanceCount) {
                    b.instanceCount--;
                    if (!b.instanceCount && (q(), b.playState = 0, b.paused = !1, b.instanceCount = 0, b.instanceOptions = {}, b._iO = {}, I(), b.isHTML5)) b.position = 0;
            ...
            this._whileloading = function(a, c, e, d) {
                ...
                b.bufferLength = d;
                if (f.isMovieStar) b.durationEstimate = b.duration;
                else if (b.durationEstimate = f.duration ? b.duration > f.duration ? b.duration : f.duration : parseInt(b.bytesTotal / b.bytesLoaded * b.duration, 10), "undefined" ===
                    typeof b.durationEstimate) b.durationEstimate = b.duration;
                if (!b.isHTML5) b.buffered = [{
                    start: 0,
                    end: b.duration
                }];
            ...
            this._whileplaying = function(a, c, e, d, f) {
                ...
                if (!b.isHTML5 && 8 < j) {
                    if (g.usePeakData && "undefined" !== typeof c && c) b.peakData = {
                        left: c.leftPeak,
                        right: c.rightPeak
                    };
                    if (g.useWaveformData && "undefined" !== typeof e && e) b.waveformData = {
                        left: e.split(","),
                        right: d.split(",")
                    };
            ...
            this._onconnect = function(a) {
                a = 1 === a;
                if (b.connected = a) b.failures = 0, p(b.id) && (b.getAutoPlay() ? b.play(void 0, b.getAutoPlay()) : b._iO.autoLoad && b.load()), b._iO.onconnect && b._iO.onconnect.apply(b, [a])
            };
        ...
        r = function(a, e) {
            ...
            for (g in b) b.hasOwnProperty(g) && "undefined" === typeof d[g] && (d[g] = "object" !== typeof b[g] || null === b[g] ? b[g] : r(d[g], b[g]));
            return d
        };
        T = {
            onready: 1,
            ...
            for (d in a)
                if (a.hasOwnProperty(d))
                    if ("object" !== typeof a[d] ||
                        null === a[d] || a[d] instanceof Array) g && "undefined" !== typeof T[e] ? c[e][d] = a[d] : "undefined" !== typeof f[d] ? (c.setupOptions[d] = a[d], c[d] = a[d]) : "undefined" === typeof T[d] ? (H(u("undefined" === typeof c[d] ? "setupUndef" : "setupError", d), 2), b = !1) : c[d] instanceof Function ? c[d].apply(c, a[d] instanceof Array ? a[d] : [a[d]]) : c[d] = a[d];
                    else if ("undefined" === typeof T[d]) H(u("undefined" === typeof c[d] ? "setupUndef" : "setupError", d), 2), b = !1;
            else return ka(a[d], d);
            return b
        };
        o = function() {
            function a(a) {
        ...
        v = {
            ...
            canplay: m(function() {
                ...
                a._html5_canplay = !0;
                a._onbufferchange(0);
                c = "undefined" !== typeof a._iO.position &&
                    !isNaN(a._iO.position) ? a._iO.position / 1E3 : null;
            ...
            loadeddata: m(function() {
                var a = this._t;
                if (!a._loaded && !ya) a.duration = a._get_html5_duration()
            }),
            ...
            progress: m(function(a) {
                ...
                c.buffered = [];
                if (g && g.length) {
                    for (d = 0, b = g.length; d < b; d++) c.buffered.push({
                        start: g.start(d),
                        end: g.end(d)
                    });
                    g = g.end(0) - g.start(0);
                ...
                isNaN(d) || (c._onbufferchange(0), c._whileloading(d, f, c._get_html5_duration()), d && f && d === f && v.canplaythrough.call(this,
                    a))
            }),
        ...
        P = function(a) {
            ...
            var e = a.url || null,
                ...
                d = c.audioFormats,
                b;
            if (a && "undefined" !== typeof c.html5[a]) return c.html5[a] &&
                !R(a);
            if (!x) {
                x = [];
                for (b in d) d.hasOwnProperty(b) && (x.push(b), d[b].related && (x = x.concat(d[b].related)));
                x = RegExp("\\.(" + x.join("|") + ")(\\?.*)?$", "i")
            }
        ...
        Ma = function() {
            function a(a) {
                ...
                if (a instanceof Array) {
                    for (b = 0, d = a.length; b < d && !f; b++)
                        if (c.html5[a[b]] || e.canPlayType(a[b]).match(c.html5Test)) f = !0, c.html5[a[b]] = !0, c.flash[a[b]] = !!a[b].match(Sa);
                    b = f
            ...
            for (d in f)
                if (f.hasOwnProperty(d) && (b = "audio/" + d, g[d] = a(f[d].type), g[b] = g[d],
                        d.match(Sa) ? (c.flash[d] = !0, c.flash[b] = !0) : (c.flash[d] = !1, c.flash[b] = !1), f[d] && f[d].related))
                    for (b = f[d].related.length - 1; 0 <= b; b--) g["audio/" + f[d].related[b]] = g[d], c.html5[f[d].related[b]] = g[d], c.flash[f[d].related[b]] = g[d];
        ...
        Ga = function(a) {
            for (var c in a) a.hasOwnProperty(c) && "function" === typeof a[c] && (a[c] = ha)
        };
        X = function(a) {
            "undefined" === typeof a && (a = !1);
            (s || a) && c.disable(a)
        ...
        sa = function() {
            ...
            if (c.ok()) {
                ...
                if (n) c.oMC.className = G() + " movieContainer " + (null === a ? "swf_timedout" : "swf_error");
                c.didFlashBlock = !0;
                B({
                    type: "ontimeout",
                    ignoreInit: !0,
        ...
        B =
            function(a) {
                ...
                if (!k && a && !a.ignoreInit || "ontimeout" === a.type && (c.ok() || s && !a.ignoreInit)) return !1;
                var e = {
                ...
                if (b.length)
                    for (a = 0, g = b.length; a < g; a++)
                        if (b[a].scope ? b[a].method.apply(b[a].scope, e) : b[a].method.apply(this, e), !f) b[a].fired = !0;
                return !0
            };
        C = function() {
        ...
        wa = function() {
            ...
            var a = !1,
                ...
                d = c.plugins,
                b, g = h.ActiveXObject;
            if (d && d.length)(c = c.mimeTypes) && c["application/x-shockwave-flash"] && c["application/x-shockwave-flash"].enabledPlugin && c["application/x-shockwave-flash"].enabledPlugin.description && (a = !0);
        ...
        La = function() {
            ...
            } else if (c.useHTML5Audio) c.hasHTML5 = !c.html5 || !c.html5.canPlayType ? !1 : !0;
            if (c.useHTML5Audio && c.hasHTML5)
                for (e in d)
                    if (d.hasOwnProperty(e) && (d[e].required && !c.html5.canPlayType(d[e].type) || c.preferFlash && (c.flash[e] || c.flash[d[e].type]))) a = !0;
            c.ignoreFlash && (a = !1);
        ...
        Ia = function(a) {
            if (!a._hasTimer) a._hasTimer = !0, !za && c.html5PollingInterval && (null === O && 0 === $ && (O = h.setInterval(Ka, c.html5PollingInterval)), $++)
        };
        Ja = function(a) {
            if (a._hasTimer) a._hasTimer = !1, !za && c.html5PollingInterval && $--
        };
        Ka = function() {
            var a;
            if (null !== O && !$) return h.clearInterval(O), O = null, !1;
            for (a = c.soundIDs.length - 1; 0 <= a; a--) c.sounds[c.soundIDs[a]].isHTML5 &&
            ...
            for (d in a)
                if (a.hasOwnProperty(d) && ("mp3" === d || "mp4" === d))
                    if (c.html5[d] = !1, a[d] && a[d].related)
                        for (e = a[d].related.length - 1; 0 <= e; e--) c.html5[a[d].related[e]] = !1
        };
        this._setSandboxType =
            function() {};
        ...
        W = function(a, e) {
            ...
            if (J && K) return !1;
            if (c.html5Only) return ma(), c.oMC = S(c.movieID), ia(), K = J = !0, !1;
            var b = e || c.url,
                g = c.altURL || b,
                f;
            f = pa();
            ...
            if (null !== c.wmode && (q.match(/msie 8/i) || !y && !c.useHighPerformance) && navigator.platform.match(/win32|win64/i)) c.wmode = null;
            f = {
                name: a,
                id: a,
                src: e,
            ...
            if (f = pa())
                if (c.oMC = S(c.movieID) || l.createElement("div"), c.oMC.id) {
                    ...
                    c.oMC.appendChild(b);
                    if (y) h = c.oMC.appendChild(l.createElement("div")), h.className = "sm2-object-box", h.innerHTML = i;
                    K = !0
                } else {
                    c.oMC.id = c.movieID;
                    ...
                    if (Xa) c.oMC.style.zIndex = 1E4;
                    if (!c.debugFlash)
                        for (k in j) j.hasOwnProperty(k) && (c.oMC.style[k] = j[k]);
                    try {
        ...
        V = function() {
            if (c.html5Only) return W(), !1;
            if (i) return !1;
            i = c.getMovie(c.id);
            if (!i) M ? (y ? c.oMC.innerHTML = ra : c.oMC.appendChild(M), M = null, J = !0) : W(c.id, c.url), i = c.getMovie(c.id);
        ...
        Ea = function() {
            ...
            setTimeout(function() {
                a = c.getMoviePercent();
                if (e) return N = !1, h.setTimeout(D, 1), !1;
                !k && Ra && (null === a ? c.useFlashBlock || 0 === c.flashLoadTimeout ? c.useFlashBlock &&
                    sa() : X(!0) : 0 !== c.flashLoadTimeout && X(!0))
            }, c.flashLoadTimeout)
        };
        U = function() {
            if (Aa || !ca) return o.remove(h, "focus", U), !0;
            Aa = Ra = !0;
            N = !1;
            D();
            o.remove(h, "focus", U);
        ...
        Oa = function() {
            var a, e = [];
            if (c.useHTML5Audio && c.hasHTML5)
                for (a in c.audioFormats) c.audioFormats.hasOwnProperty(a) && e.push(a + ": " + c.html5[a] + (!c.html5[a] && t && c.flash[a] ? " (using flash)" : c.preferFlash && c.flash[a] && t ? " (preferring flash)" : !c.html5[a] ? " (" + (c.audioFormats[a].required ? "required, " : "") + "and no flash support)" : ""))
        };
        L = function(a) {
            if (k) return !1;
            if (c.html5Only) return k = !0, C(), !0;
            var e = !0,
                d;
            if (!c.useFlashBlock || !c.flashLoadTimeout || c.getMoviePercent()) k = !0, s && (d = {
        ...
        Da = function() {
            var a, e = c.setupOptions;
            for (a in e) e.hasOwnProperty(a) && ("undefined" === typeof c[a] ? c[a] = e[a] : c[a] !==
                e[a] && (c.setupOptions[a] = c[a]))
        };
        ia = function() {
            if (k) return !1;
            if (c.html5Only) {
                if (!k) o.remove(h, "load", c.beginDelayedInit), c.enabled = !0, L();
                return !0
            }
            V();
            try {
                i._externalInterfaceTest(!1), Fa(!0, c.flashPollingInterval || (c.useHighPerformance ? 10 : 50)), c.debugMode || i._disableDebug(), c.enabled = !0, c.html5Only || o.add(h, "unload", ha)
            } catch (a) {
                return F({
        ...
        o.add(h, "load", D);
        o.add(h, "load", na);
        l.addEventListener ? l.addEventListener("DOMContentLoaded", E, !1) : l.attachEvent ? l.attachEvent("onreadystatechange",
            va) : F({
            type: "NO_DOM2_EVENTS",
            fatal: !0
        });
    ...
    var da = null;
    if ("undefined" === typeof SM2_DEFER || !SM2_DEFER) da = new Q;
    ea.SoundManager = Q;
    ea.soundManager = da
})(window);